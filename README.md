...
|------|------|-----------|------------------|--------|
| **🎯 Project Lead** | **Ganang Setyo Hadi** | Project Management + Backend Engineering + AI Integration | • Strategic project planning & execution<br/>• Backend architecture & API development<br/>• ML services integration & deployment<br/>• Team coordination & technical leadership | [@notsuperganang](https://github.com/notsuperganang) |
